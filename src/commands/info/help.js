  ...
  run(message, args) {
    ...
    if (
      ...
      embed // Build specific command help embed
        ...
        .setThumbnail('https://media.discordapp.net/attachments/787220903582105620/814819013476876358/PicsArt_02-25-08.39.33.jpg?width=307&height=426')
      ...
      embed // Build help embed
        ...
        .setTimestamp()
        .setImage('https://media.discordapp.net/attachments/787220903582105620/814819013476876358/PicsArt_02-25-08.39.33.jpg?width=307&height=426')
        .setColor(message.guild.me.displayHexColor);
